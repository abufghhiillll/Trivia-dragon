...
bot.on('message', message =>{
    ...
    var prefix = ">" //The text before commands, you can put anything that you prefer
        ...
        if(msg.startsWith('>', 0)){
            if(msg === prefix + "gt" 
                message.channel.send('its game time!!!!!') // Sends a message to the channel, with the content
            }
            else{
...
bot.login(process.env.NTgwNjg1ODc0ODU0MTAxMDAy.XOUVdQ.j8lujgPKykLKRuaieY50WJdjmOY)
